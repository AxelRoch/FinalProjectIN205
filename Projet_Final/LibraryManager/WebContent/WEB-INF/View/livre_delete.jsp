...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Suppression du livre ${idDuLivre}</h5> 
        <div class="row">
          <p>�tes-vous s�r de vouloir supprimer le livre ${titre} de ${auteur} (code ${isbn}) ?</p> 
	      <form action="/LibraryManager/livre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/LibraryManager/livre_details?id=${idDuLivre}">Annuler</a> 
	        </div>
	      </form>
	    </div>	    
      </div>
